...
public class ViewPagerActivity extends ActionBarActivity {
    ...
    static ArrayList<ContentItem> getSampleContent() {
        ...
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "img_friend1.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "img_friend2.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "img_friend3.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "img_friend4.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "img_friend5.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "img_friend6.jpg"));
